    ...
    return (
        <>
            ...
            <section className="home">
                ...
                <p>I've helped many companies, from multi-national corporations such as <strong>Volvo</strong>, <strong>Peugeot Citroën Automobiles</strong> and <strong>Volkswagen</strong> to <strong>independent retailers</strong> and <strong>local councils</strong>, to achieve their digital aspirations.</p>
